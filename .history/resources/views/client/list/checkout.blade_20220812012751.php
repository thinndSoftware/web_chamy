                        ...
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text" placeholder="Quận, Huyện" class="checkout__input__add"
                                    name="address_wards" class="@error('address_wards') is-invalid @enderror">
                                @error('address_wards')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                <input type="text" placeholder="Căn hộ, dãy phòng, căn hộ, v.v. (tùy chọn)"
                                    name="address_detail" class="@error('address_detail') is-invalid @enderror">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text" name="address_city" class="@error('address_city') is-invalid @enderror">
                                @error('address_city')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
