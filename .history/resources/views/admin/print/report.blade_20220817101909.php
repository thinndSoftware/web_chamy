                ...
                <tbody>
                    ...
                    @foreach ($reports as $key => $report)
                        ...
                        <tr>
                            ...
                            <td scope="row" colspan="2" style=" border: 1px solid black;
            border-collapse: collapse;" >{{ $report->order_id }}</td>
                            <td scope="row" class="text-right">{{ $report->order_total }} vnđ</td>
                            <td scope="row" class="text-right">{{ $report->created_at }}</td>
                        <tr>
                    @endforeach
                    <tr style="border: none">
                        <td style="border: none">Tổng số hóa đơn</td>
                        <td style="border: none">{{ $key+1 }}</td>
                        <td style="border: none">Tổng Doanh thu</td>
                        <td style="border: none">{{ number_format($totalReport) }} vnđ</td>
                    </tr>
                </tbody>
            </table>
        </div>
