        ...
        @if (!empty($DateTimeBeforeFormat) && !empty($DateTimeAfterFormat))
            <form action="{{ route('report.getReport') }}" method="post">
                ...
                <div class=row>
                    ...
                    <div class="col-3 mt-4">
                        <a href="{{ route('report.product') }}" class="btn btn-secondary">Theo Sản Phẩm</a>
                    </div>
                </div>
            </form>
        @else
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Thơi gian</th>
                            </tr>
                        </thead>
                        <tbody>
                            @php
                            ...
                            @foreach ($products as $key => $product)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p>
                                            {{ $product->product_discount }} vnđ
                                        </p>
                                    </td>
                                    <td>
                                        <p>
                                            {{ $report->product_qty*$product->product_discount }}vnđ
                                        </p>
                                    </td>
                                    <td>
                                        <p>
                            ...
                            <tr class="bg-secondary">
                                ...
                                <td class="text-danger" colspan="2">{{ number_format($totalReport) }} vnđ</td>
                                <td></td>
                            </tr>
                        </tbody>
                    </table>
