<aside
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white bg-gradient-primary {{ Route::is('menus.menu') ? 'active bg-gradient-primary' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::is('settings.setting') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::is('users.user') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::is('roles.role') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::is('permissions.create') ? 'active' : '' }}"
