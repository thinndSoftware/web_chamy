                ...
                <div class=row>
                    <div class="col-2">
                        <div class="input-group input-group-static my-3">
                            <label>Từ</label>
                            <input type="datetime-local" class="form-control @error('date_time_before') is-invalid @enderror" name="date_time_before"
                    ...
                    <div class="col-2">
                        <div class="input-group input-group-static my-3">
                            <label>Đến</label>
                            <input type="datetime-local" class="form-control @error('date_time_after') is-invalid @enderror" name="date_time_after"
                                value="{{ $DateTimeAfter }}">
