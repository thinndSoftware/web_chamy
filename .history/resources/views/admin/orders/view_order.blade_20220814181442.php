...
@section('content')
    ...
    <div class=row>
        ...
        <div class="col-6 d-flex justify-content-end align-items-center">
            <a target="_blank" href="{{ Route('order.print',['id' => $id]) }}" class="btn btn-success" style="margin-right: 3rem">In đơn hàng</a>
        </div>
    </div>
                        ...
                        @foreach ($product_order as $key => $product_orderDetail)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <p>
                                            {{ number_format($product_orderDetail->product_discount) }} VND
                                        </p>
                                    </div>
                                </td>
                                <td>
