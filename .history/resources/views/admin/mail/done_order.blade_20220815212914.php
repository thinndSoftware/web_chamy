                ...
                <tbody>
                    @foreach ($product_order as $key => $product_orderDetail)
                        <tr>
                            ...
                            <td class="text-center">{{ dd($product_orderDetail->product_discount) }} vnđ</td>
                    ...
                    <tr>
                        <td colspan="6">
                            <p class="text-right">Tổng cộng tiền thanh toán: {{ number_format($order_by_id->order_total) }} vnd</p>
                        </td>
                    </tr>
                </tbody>
            </table>
