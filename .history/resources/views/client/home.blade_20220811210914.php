            ...
            <div class="row featured__filter">
                @foreach ($categories as $indexCategoryProduct => $valueCategoryProduct)
                    @foreach ($valueCategoryProduct->products->take(8) as $productItemtab)
                        <div class="col-lg-3 col-md-4 col-sm-6 mix product{{ $valueCategoryProduct->category_id }} fresh-meat">
                            <div class="featured__item">
                                <div class="featured__item__pic set-bg"
                                    data-setbg="{{ asset($productItemtab->product_vartar_path) }}">
                                    <ul class="featured__item__pic__hover">
                                        <li><a href="{{ route('shop-details', ['id' => $productItemtab->id]) }}"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
