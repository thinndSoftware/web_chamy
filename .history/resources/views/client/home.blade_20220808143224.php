                    ...
                    @foreach ($categories as $category)
                        <div class="col-lg-3">
                            <div class="categories__item set-bg" data-setbg="{{ asset($category->image_path) }}">
                                <h5><a href="{{ route('product',['id'=>$category->category_id]) }}">{{ $category->category_name }}</a></h5>
                            </div>
                        </div>
                    @endforeach
                    {{-- end category --}}
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 mix {{ $valueCategoryProduct->category_name }} fresh-meat">
                            <div class="featured__item">
                                ...
                                <div class="featured__item__text">
                                    <h6><a href="{{ route('shop-details',['id'=>$productItemtab->id]) }}">{{ $productItemtab->name }}</a></h6>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="latest-product__text">
                        ...
                        <div class="latest-product__slider owl-carousel">
                            ...
                            <div class="latest-prdouct__slider__item">
                                <a href="{{ route('shop-details',['id'=>$valueAppreci->id]) }}" class="latest-product__item">
                                    <div class="latest-product__item__pic">
