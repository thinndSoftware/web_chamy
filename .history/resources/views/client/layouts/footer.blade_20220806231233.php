            ...
            <div class="col-lg-4 col-md-12">
                <div class="footer__widget">
                    ...
                    <div class="footer__widget__social">
                        <a href="{{ getConfigValueFromSettingTable() }}"><i class="fa fa-facebook"></i></a>
                        <a href="{{ getConfigValueFromSettingTable() }}"><i class="fa fa-instagram"></i></a>
                        <a href="{{ getConfigValueFromSettingTable() }}"><i class="fa fa-youtube"></i></a>
                        <a href="{{ getConfigValueFromSettingTable() }}"><i class="fa fa-twitter"></i></a>
                    </div>
                </div>
            </div>
        </div>
