...
@section('content')
    @include('admin.layout.nav_content', [
        'name' => 'order_by_id',
        'key' => 'List Detail order_by_id',
        'url' => route('order_by_ids.order_by_id'),
    ])
                ...
                <table class="table align-items-center mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Địa chỉ giao hàng
                                tiền
                            </th>
