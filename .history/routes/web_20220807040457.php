...
Route::get('/shop-grid', [HomeController::class, 'product'])->name('product')->redirect('category.product');
...
Route::get('/category/product/{id}', [ClientCategoryController::class, 'index'])->name('category.product');
