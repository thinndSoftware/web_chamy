                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-secondary">
                                <td class="text-danger">Tổng số hóa đơn:</td>
                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-secondary">
                                ...
                                <td class="text-danger text-end" colspan="2">{{ number_format($totalProduct) }} vnđ
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-secondary">
                                ...
                                <td class="text-danger text-end" colspan="1">{{ number_format($totalProduct) }} vnđ
                                </td>
                            </tr>
                        </tbody>
                    </table>
