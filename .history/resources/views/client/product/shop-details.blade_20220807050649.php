                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        ...
                        <div class="product__details__pic__slider owl-carousel">
                            @foreach ($productDetail->images as $productImagesDetail)
                                <img data-imgbigurl="{{ asset($productImagesDetail->image_detail_link) }}"
                                    src="{{ asset($productImagesDetail->image_detail_link) }}" alt="{{ $productImagesDetail->image_detail }}">
                            @endforeach
