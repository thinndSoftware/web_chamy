...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Gate::define('list_user', [RolePolicy::class, 'view']);
        Gate::define('add_user', [RolePolicy::class, 'create']);
        Gate::define('edit_user', [RolePolicy::class, 'update']);
        Gate::define('delete_user', [RolePolicy::class, 'delete']);
    }
}
