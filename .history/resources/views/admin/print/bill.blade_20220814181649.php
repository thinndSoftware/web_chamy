                ...
                <tbody>
                    @foreach ($product_order as $key => $product_orderDetail)
                        <tr>
                            ...
                            <td class="text-center" align="center">{{ $product_orderDetail->product_qty }}</td>
                            <td class="text-center">{{ $product_orderDetail->product_discount }}</td>
                            <td class="text-center">
                                {{ $product_orderDetail->product_qty * $product_orderDetail->product_discount }}</td>
                        </tr>
                    @endforeach
                    <tr>
                        <td colspan="4"></td>
                        <td>
                            <p class="text-right">Tổng cộng tiền thanh toán: {{ $order_by_id->order_total }} vnd</p>
                        </td>
                    </tr>
                </tbody>
            </table>
