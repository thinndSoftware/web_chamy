                ...
                <tbody>
                    @foreach ($product_order as $key => $product_orderDetail)
                        <tr>
                            ...
                            <td class="text-center">{{ number_forrmat($product_orderDetail->product_discount) }} vnđ</td>
                            <td class="text-center">
                                {{ number_forrmat($product_orderDetail->product_qty * $product_orderDetail->product_discount) }} vnđ</td>
                        </tr>
                    @endforeach
                    ...
                    <tr>
                        <td colspan="6">
                            <p class="text-right">Tổng cộng tiền thanh toán: {{ number_forrmat($order_by_id->order_total) }} vnd</p>
                        </td>
                    </tr>
                </tbody>
            </table>
