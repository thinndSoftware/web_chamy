                            ...
                            <div class="product__details__quantity">
                                <div class="quantity">
                                    <div class="pro-qty">
                                        ...
                                        <input type="hidden" name="product_id_hidden" value="{{ $productDetail->id }}">
                                    </div>
                                </div>
                            </div>
                            <button type="submit" class="primary-btn"
                                style="border: none;border-radius: 4px;">ADD TO CARD</button>
                        </form>
                        <ul>
                        ...
                        <div class="product__item">
                            <div class="product__item__pic set-bg"
                                ...
                                <ul class="product__item__pic__hover">
                                    <li><a href="{{ route('shop-details', ['id' => $productsRecommendItem->id]) }}">{{ $productsRecommendItem->name }}"><i class="fa fa-shopping-cart"></i></a></li>
                                </ul>
                            </div>
                            <div class="product__item__text">
                                <h6><a
                                        href="{{ route('shop-details', ['id' => $productsRecommendItem->id]) }}">{{ $productsRecommendItem->name }}</a>
                                </h6>
