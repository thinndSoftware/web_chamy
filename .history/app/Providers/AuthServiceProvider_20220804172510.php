...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Gate::define('list_setting', [UserPolicy::class, 'view']);
        Gate::define('add_setting', [UserPolicy::class, 'create']);
        Gate::define('edit_setting', [UserPolicy::class, 'update']);
        Gate::define('delete_setting', [UserPolicy::class, 'delete']);
    }
}
