        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Tên khách hàng: Lê Na</p>
                    <p class="card-text">Địa chỉ: Hà Nội</p>
                    <p class="card-text">Số điện thoại: 0965372651</p>
                    <p class="card-text">Mã Hóa Đơn: 1</p>
                    <p class="card-text">Mã Sản Phẩm: 2</p>
                    <p class="card-text">Tình trạng lỗi: test</p>
                    <p class="card-text">Ngày bảo hành: 2022-08-10</p>
                    <p class="card-text">Ghi chú: Cần nhanh</p>
                </div>
            </div>
            @endif
            </div>
