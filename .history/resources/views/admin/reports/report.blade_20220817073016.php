                ...
                <div class="col-2">
                    <div class="input-group input-group-static my-3">
                        ...
                        <input type="datetime-local" class="form-control @error('date_time_before') is-invalid @enderror"
                            name="date_time_before" value="{{ Carbon::parse($DateTimeBeforeFormat)->format('YYYY-MM-DDThh:mm') ?? old('date_time_before') }}">
                ...
                <div class="col-2">
                    <div class="input-group input-group-static my-3">
                        ...
                        <input type="datetime-local" class="form-control @error('date_time_after') is-invalid @enderror"
                            name="date_time_after" value="{{ Carbon::parse($DateTimeBeforeFormat)->format('YYYY-MM-DDThh:mm') ?? old('date_time_before') }}">
                        ...
                        <tbody>
                            ...
                            @foreach ($products as $key => $product)
                                <tr>
                                    ...
                                    <td>
                                        <p>
                                            {{ number_format($product->product_discount) }} vnđ
                                        </p>
                                    </td>
                                    <td>
                                        <p class="text-end">
                                            {{ number_format($product->product_qty * floatval(implode(explode(',', $product->product_discount)))) }}
                                            vnđ
                                        </p>
                                    </td>
                                    @php
                            ...
                            <tr class="bg-secondary">
                                ...
                                <td class="text-danger text-end" colspan="2">{{ number_format($totalProduct) }} vnđ</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div class="col-12 d-flex justify-content-center m-6">
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 text-end">Thanh
                                    toán</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            @endforeach
                            <tr class="bg-secondary">
                                <td class="text-danger" colspan="5">Tổng Doanh thu</td>
                                <td class="text-danger text-end" colspan="1">{{ number_format($totalProduct) }} vnđ</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
