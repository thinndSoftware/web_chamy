                ...
                <form action="#">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <a href="{{ route('register') }}" class="text-primary" style="text-decoration: underline">Tạo
                                tài khoản.
                                đầu trang</a><a href="{{ route('login') }}" class="text-primary"
                                style="text-decoration: underline"> Nếu bạn là khách hàng cũ, vui lòng đăng nhập ở</a>
                        </div>
                            ...
                            <div class="checkout__order">
                                ...
                                <ul>
                                    @foreach (Cart::content() as $content)
                                        <li>{{ $content->name }}<span>{{ number_format($content->price) }}</span></li>
                                    @endforeach
