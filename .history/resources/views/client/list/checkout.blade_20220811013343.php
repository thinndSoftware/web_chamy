                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text" placeholder="Xã phường" class="checkout__input__add" name="address_wards">
                                <input type="text" placeholder="Căn hộ, dãy phòng, căn hộ, v.v. (tùy chọn)" name="address_detail">
                            </div>
                            <div class="checkout__input">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text"
                                    placeholder="Ghi chú về đơn đặt hàng của bạn, ví dụ: lưu ý đặc biệt khi giao hàng." name="desscription">
                            </div>
                        </div>
