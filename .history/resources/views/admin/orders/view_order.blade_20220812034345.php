    ...
    <div class="container-fluid py-4">
        ...
        <div class="card">
            <div class="table-responsive">
                <h5 class="font-weight-normal mt-3" style="text-align: center">
                   Thông tin người mua
                </h5>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center text-sm">
                                {{-- @can('order_edit') --}}
                                <a href="{{-- {{ route('orders.edit', ['id' => $order->id]) }} --}}" class="btn btn-info">Sửa</a>
                                {{-- @endcan --}}
                                {{-- @can('order_delete') --}}
                                <a href="{{-- {{ route('orders.delete', ['id' => $order->id]) }} --}}" data-url="{{-- {{ route('orders.delete', ['id' => $order->id]) }} --}}"
