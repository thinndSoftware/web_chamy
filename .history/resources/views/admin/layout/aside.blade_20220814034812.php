<aside
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::is('report.product') ? 'active bg-gradient-primary' : '' }} "
                    href="{{ route('report.product') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-bars"></i>
                    </div>
                    <span class="nav-link-text ms-1">Báo cáo Doanh Thu</span></br><span>(Theo sản phẩm)</span>
                </a>
            </li>
            {{-- <li class="nav-item">
