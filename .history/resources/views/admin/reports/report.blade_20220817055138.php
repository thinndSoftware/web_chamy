                        ...
                        <tbody>
                            ...
                            @foreach ($productsQty as $key => $product)
                                <tr>
                                    ...
                                    <td>
                                        <p>
                                            {{ $productsQty->product_id }}
                                        </p>
                                    </td>
                                    <td>
                                        <p>
                                            {{ $productsQty->product_name }}
                                        </p>
                                    </td>
                                    <td>
                                        <p>
                                            {{ $productsQty->product_qty }}
                                        </p>
                                    </td>
                                    <td>
                                        <p>
                                            {{ $productsQty->product_discount }}
                                        </p>
                                    </td>
                                    <td>
                                        <p>
                                            {{ $productsQty->product_qty * floatval(implode(explode(',', $productsQty->product_discount))) }}
                                            vnđ
                                        </p>
                                    </td>
                                    @php
                                        $totalProduct += $productsQty->product_qty * floatval(implode(explode(',', $productsQty->product_discount)));
                                    @endphp
                                    <td>
                                        <p>
                                            {{ $productsQty->updated_at }}
                                        </p>
                                    </td>
                                </tr>
                            @endforeach
