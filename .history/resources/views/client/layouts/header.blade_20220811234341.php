            ...
            <div class="col-lg-6">
                <nav class="header__menu">
                    <ul>
                        ...
                        <li class="{{ (Route::is('product') || Route::is('shop-details')|| Route::is('shoping-cart')|| Route::is('checkout')) ? 'active' : '' }}"><a href="{{ route('product', ['id' => 5]) }}">Sản Phẩm</a></li>
                        {{-- <li><a href="#">Danh mục</a>
                            <ul class="header__menu__dropdown">
                                <li><a href="{{route('blog_details',['id'=>1])}}">Tin tức về sản phẩm</a></li>
                            </ul>
                        </li>  --}}
                        <li class="{{ (Route::is('blog')|| Route::is('blog-details')) ? 'active' : '' }}"><a href="{{ route('home') }}"><a href="{{ route('blog') }}">Tin Tức</a></li>
