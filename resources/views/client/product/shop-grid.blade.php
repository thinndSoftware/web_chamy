    ...
    <div class="c-box_products ">
        ...
        <div class="main_products">
            ...
            <div class="list">
                ...
                @foreach ($productList as $keyRecommend => $valueRecommend)
                                            @if ($keyRecommend % 3 == 0 && $keyRecommend != 0)
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 c-item c-item1">
                        <a href="{{ route('shop-details', ['id' => $valueRecommend->id]) }}" title="Dark Red Box Pleated Midi Skirt"
                            class="c-image">
                        ...
                        <div class="price">
                            <p class="c-price">
                                ...
                                <p style="text-decoration:line-through;">{{ number_format($valueRecommend->price) }} VND</p>
                        ...
                        <p class="c-box_color">
                            <a class="c-color  active c-default" href="javascript:void(0)" data-action="1"
                                data-rel="{{ asset($valueRecommend->product_vartar_path) }}" title="Đỏ Đậm"
