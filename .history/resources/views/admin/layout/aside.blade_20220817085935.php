<aside
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ (Route::is('orders.order')||Route::is('orders.view')) ? 'active bg-gradient-primary' : '' }} "
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ (Route::is('report.view') || Route::is('report.getReport')|| Route::is('report.print')) ? 'active bg-gradient-primary' : '' }} "
