...
class AdminReportController extends Controller
{
    ...
    public function getReport(Request $request)
    {
        ...
        $DateTimeAfter = Carbon::parse($request->date_time_after)->format('Y-m-d H:h:s');;
        $report = DoneOrder::whereBetween('created_at', [$DateTimeBefore, $DateTimeAfter])->get()->dd();
        return view('admin.reports.report',compact('report'));
    }
}
