            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        <a href="{{ route('product') }}" class="primary-btn cart-btn">Tiếp Tục Mua Sắm</a>
                        <a href="{{ route('save_cart') }}" class="primary-btn cart-btn cart-btn-right"><span class="icon_loading"></span>
                            Cập Nhật Giá Tiền</a>
                    </div>
                </div>
                <div class="col-lg-6">
