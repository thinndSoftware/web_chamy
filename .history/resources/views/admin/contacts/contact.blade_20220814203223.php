    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="row pt-4 ps-4">
                <div class="col6">
                    <p class="font-weight-bold">Tên người gửi: <span class="font-weight-normal">Trịnh Hồng Nam</span></p>
                </div>
                <div class="col6">
                    <p class="font-weight-bold">Email người gửi: <span class="font-weight-normal">namphieu123@gmail.com</span></p>
                </div>
            </div>
            <div class="row ps-4">
