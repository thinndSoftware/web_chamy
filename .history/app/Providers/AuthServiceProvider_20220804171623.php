...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Gate::define('list_slider', [SettingPolicy::class, 'view']);
        Gate::define('add_slider', [SettingPolicy::class, 'create']);
        Gate::define('edit_slider', [SettingPolicy::class, 'update']);
        Gate::define('delete_slider', [SettingPolicy::class, 'delete']);
    }
}
