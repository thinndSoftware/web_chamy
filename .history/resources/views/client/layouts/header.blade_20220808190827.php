                ...
                <div class="col-lg-6 col-md-6">
                    <div class="header__top__right">
                        <div class="header__top__right__social">
                            ...
                            <a href="{{ getConfigValueFromSettingTable('contact_instagram') }}"><i class="fa fa-instagram"></i></a>
                            <a href="{{ getConfigValueFromSettingTable('youtobe_contact') }}"><i class="fa fa-youtube"></i></a>
                            <a href="{{ getConfigValueFromSettingTable('contact_twitter') }}"><i class="fa fa-twitter"></i></a>
                        </div>
                    ...
                    <ul>
                        ...
                        <li><a href="#">Danh mục</a>
                            <ul class="header__menu__dropdown">
                                <li><a href="{{route('blog_details',1)}}">Tin tức về sản phẩm</a></li>
                            </ul>
                        </li>
