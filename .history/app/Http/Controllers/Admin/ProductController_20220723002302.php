    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('image_list')){
            foreach($request->file('image_list') as $fileItems){
                ...
                $dataProductCreateDetail['image_list_name'] = $dataProductImageList['file_name'];
                $dataProductCreateDetail['image_list_path'] = $dataProductImageList['file_path'];
            }
            $dataProductCreateDetail['product_id'] = $request->id;
            ProductImage::create($dataProductCreate);
        }
