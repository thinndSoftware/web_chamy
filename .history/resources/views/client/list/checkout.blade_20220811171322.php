                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text" placeholder="Quận, Huyện" class="checkout__input__add" name="address_wards">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text"
                                    placeholder="Ghi chú về đơn đặt hàng của bạn, ví dụ: lưu ý đặc biệt khi giao hàng." name="description">
                            </div>
                        </div>
