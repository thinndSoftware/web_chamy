                ...
                @foreach ($products as $product)
                    <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                        <div class="featured__item">
                            <div class="featured__item__pic set-bg" data-setbg="{{ asset($product->product_vartar_path) }}">
                            ...
                            <div class="featured__item__text">
                                ...
                                <h5>{{ number_format($product->discount) }} VND </h5>
                            </div>
                        </div>
                    </div>
                @endforeach
                                ...
                                @foreach ($productsRecommend as $keyRecommend => $valueRecommend)
                                    <a href="#" class="latest-product__item">
                                        ...
                                        <div class="latest-product__item__text">
                                            ...
                                            <span>{{ $valueRecommend->discount }}</span>
                                        </div>
                                    </a>
                                @endforeach
