            ...
            <div class="row featured__filter">
                @foreach ($categories as $indexCategoryProduct => $valueCategoryProduct)
                    @foreach ($valueCategoryProduct->products->take(8) as $productItemtab)
                        <div
                            class="col-lg-3 col-md-4 col-sm-6 mix product{{ $valueCategoryProduct->category_id }} fresh-meat">
                            <div class="featured__item">
                                <div class="featured__item__pic set-bg"
                                    data-setbg="{{ asset($productItemtab->product_vartar_path) }}">
                                    <ul class="featured__item__pic__hover">
                                        <li><a href="{{ route('shop-details', ['id' => $productItemtab->id]) }}"><i
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="blog__item">
                            ...
                            <div class="blog__item__text">
                                ...
                                <h5><a href="{{ route('blog_details', ['id' => $blogNew->id]) }}">{{ $blogNew->name }}</a>
                                </h5>
                                <p>{{ $blogNew->slogan }}</p>
                            </div>
                        </div>
