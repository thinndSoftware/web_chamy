            ...
            <div class=row>
                <div class="col-2">
                    <div class="input-group input-group-static my-3">
                        <label>Từ</label>
                        <input type="datetime-local" class="form-control" name="date_time_before" value="{{ $DateTimeBefore }}">
                    </div>
                </div>
                <div class="col-2">
                    <div class="input-group input-group-static my-3">
                        <label>Đến</label>
                        <input type="datetime-local" class="form-control" name="date_time_after" value="{{ $DateTimeAfter }}">
                    </div>
                </div>
