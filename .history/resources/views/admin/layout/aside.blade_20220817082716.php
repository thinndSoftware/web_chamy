<aside
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white {{ (Route::is('category.category'||'category.create') ? 'active bg-gradient-primary' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::is('orders.order') ? 'active bg-gradient-primary' : '' }} "
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::is('report.view') ? 'active bg-gradient-primary' : '' }} "
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::is('contact.view') ? 'active bg-gradient-primary' : '' }} "
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::is('insurance.view') ? 'active bg-gradient-primary' : '' }} "
