            ...
            <div class="col-lg-6">
                <nav class="header__menu">
                    <ul>
                        ...
                        <li class="{{ (Route::is('product') || Route::is('shop-details')|| Route::is('shoping-cart')|| Route::is('checkout')) ? 'active' : '' }}">
                            <a href="{{ route('product', ['id' => 5]) }}">Sản Phẩm</a></li>
                        {{-- <li><a href="#">Danh mục</a>
                            <ul class="header__menu__dropdown">
                                <li><a href="{{route('blog_details',['id'=>1])}}">Tin tức về sản phẩm</a></li>
                            </ul>
                        </li>  --}}
                        <li class="{{ (Route::is('blog')|| Route::is('blog_details')) ? 'active' : '' }}">
                            <a href="{{ route('blog') }}">Tin Tức</a>
                        </li>
                        <li class="{{ Route::is('contact')? 'active' : '' }}">
                            <a href="{{ route('contact') }}">Liên Hệ</a>
                        </li>
                        <li class="{{ Route::is('insurance') ? 'active' : '' }}">
                            <a href="{{ route('insurance') }}">Bảo hành</a>
                        </li>
                    </ul>
                </nav>
            </div>
            <div class="col-lg-3">
                <div class="header__cart">
                    <ul>
                        ...
                        @endphp
                        <li><a href="{{ route('shoping-cart') }}"><i class="fa fa-shopping-bag"></i><span>{{ $sumqty}}</span></a>
                        </li>
                    </ul>
                    <div class="header__cart__price">Thành Tiền <span>{{ Cart::subtotal() }}</span></div>
                </div>
            </div>
        </div>
