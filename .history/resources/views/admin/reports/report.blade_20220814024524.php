            ...
            <form action="{{ route('report.getReport') }}" method="post">
                ...
                <div class=row>
                    <div class="col-2">
                        <div class="input-group input-group-static my-3">
                            ...
                            <input type="datetime-local" class="form-control @error('date_time_before') is-invalid @enderror"
                                name="date_time_before" value="{{ $DateTimeBefore ?? old('date_time_before')}}">
                    ...
                    <div class="col-2">
                        <div class="input-group input-group-static my-3">
                            ...
                            <input type="datetime-local" class="form-control @error('date_time_after') is-invalid @enderror"
                                name="date_time_after" value="{{ $DateTimeAfter??old('date_time_after') }}">
                    ...
                    <div class="col-6 mt-4">
                        <a href="{{ route('report.print') }}" class="btn btn-success">In báo cáo</a>
                    </div>
                </div>
            </form>
        @else
                    ...
                    <div class="col-2">
                        <div class="input-group input-group-static my-3">
                            ...
                            <input type="datetime-local"
                                class="form-control @error('date_time_before') is-invalid @enderror"
                                name="date_time_before" value="{{ old('date_time_after') }}">
                            @error('date_time_before')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
