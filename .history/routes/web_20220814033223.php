...
Route::prefix('/admin')->group(function () {
    ...
    Route::prefix('reports')->group(function () {
        ...
        Route::get('/product', [AdminReportController::class, 'view-product'])->name('report.product');
        Route::post('/product', [AdminReportController::class, 'getReport'])->name('report.getProduct');
        Route::get('/print-report-product/{DateTimeBefore}/{DateTimeAfter}', [AdminReportController::class, 'print_report_product'])->name('report.product');
    });
});
