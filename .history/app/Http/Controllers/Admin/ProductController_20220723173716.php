    ...
    public function update(Request $request,$id)
    {
        try {
            ...
            if($request->hasFile('image_link')){
                ...
                $products = $this->products->update($dataUpdateImageAvatar);
            }
            if($request->hasFile('image_list')){
                foreach($request->file('image_list') as $imageDetailItem){
                    $dataUpdateImageDetail = $this->storagetraitsUploadMutiple($request->file('image_detail'),'product');
            ...
            Log::message("Messages: ".$exception->getMessage(). "Line: ". $exception->getLine() )
        }
    }
}
