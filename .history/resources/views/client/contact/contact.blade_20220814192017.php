            ...
            <form action="{{ route('contact.send') }}" method="post">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <input type="text" placeholder="Họ Tên " name="name" class="@error('name') is-invalid @enderror">
                        @error('name')
                    ...
                    <div class="col-lg-12 text-center">
                        <textarea placeholder="Lời Nhắn" name="message" class="@error('message') is-invalid @enderror"></textarea>
                        @error('message')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <input type="submit" value="Gửi tin nhắn" class="site-btn text-white w-10" name="submit">
                    </div>
                    <div class="col-lg-4 col-md-4"></div>
                </div>
            </form>
