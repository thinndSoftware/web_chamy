        ...
        <div class="card">
            ...
            <form class="p-4" action="{{ route('contact.rep') }}" method="post">
                ...
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Rep:</label>
                    <textarea class="form-control border border-primary @error('message') is-invalid @enderror" id="exampleFormControlTextarea1" rows="3"
                        name="message">
                    {{ old('message') }}
                    </textarea>
                    @error('message')
