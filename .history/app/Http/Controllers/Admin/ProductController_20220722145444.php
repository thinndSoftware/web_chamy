...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('image_list')){
            ...
            $dataProductCreate['image_list_name'] = json_encode($dataProductCreate['image_list_name']);
            $dataProductCreate['image_list_path'] = json_encode($dataProductCreate['image_list_path']);
